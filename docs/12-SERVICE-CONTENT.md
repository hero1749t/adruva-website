# Adruva Solution Website — Service Content Data

> Complete content for all 13 services. AI agent uses this to populate service pages.
> Copy-paste ready. Refine before launch.
...
4. 🎯 Conversion-Focused — Every element designed to turn visitors into customers
5. 📊 Analytics Ready — GA4, Search Console, heatmaps — know exactly how your site performs
...
4. Testing — Cross-browser, mobile, speed, form testing
5. Launch — Deploy, domain setup, go live 🚀

**Timeline:** 1–4 weeks (depends on scope)

**FAQ:**
Q: Do I need to provide content (text and images)?
A: Yes, you provide the content. We give you a content template so you know exactly what to prepare. We can help write copy for an additional fee.

Q: Will I own the website after delivery?
A: 100%. Code is pushed to your GitHub, hosting is under your name. You're never locked in with us.

Q: Can you redesign my existing website?
A: Yes — we can redesign, rebuild, or add features to an existing site.

Q: What if I need changes after launch?
A: Minor bug fixes are covered for 30 days. New features/pages are quoted separately.

Q: Do you handle hosting?
A: We set it up under your account (Vercel/hosting of your choice). You pay the hosting cost directly — typically ₹0–₹2,000/month.

Q: How long will it take?
A: Landing page: 1–2 weeks. Business website: 2–4 weeks. Web app: 6–16 weeks.
...
4. 🔔 Push Notifications — Keep users engaged and coming back
5. 🔗 API Integration — Connect to your existing systems, payment gateways, maps
...
4. Testing — Device testing (iOS + Android), performance, edge cases
5. Launch — App Store + Play Store submission + monitoring

**Timeline:** 6–16 weeks

**FAQ:**
Q: Do you build for both iOS and Android?
A: Yes — we use React Native so one codebase covers both platforms.

Q: How much does it cost to publish on App Store?
A: Apple charges $99/year (developer account). Google charges $25 one-time. These are paid by you directly.

Q: Can you add features to my existing app?
A: Yes, if it's built in React Native. We'll review the codebase first.

Q: Will the app work offline?
A: Depends on the feature. Basic offline support can be added. Full offline sync is complex — we'll scope this in discovery.

Q: Do I need a backend/server?
A: Most apps need a backend. We build it as part of the project.
...
4. 🔒 Your data, your control — No data sharing with third parties
5. 💰 No per-seat pricing — Own it outright, no monthly SaaS fees forever
...
4. Development — Phased development with regular demos
5. Testing + Launch — QA, UAT, deployment

**Timeline:** 8–20 weeks

**FAQ:**
Q: How is this different from buying existing SaaS software?
A: Custom software fits YOUR exact workflow. No workarounds, no unused features, no per-seat pricing that grows with your team.

Q: Can you build something like [specific software]?
A: Describe what you need — we'll tell you if we can build it and what it'll cost.

Q: Do you offer ongoing maintenance?
A: Yes — we offer monthly maintenance retainers after project delivery.
...
4. 📊 Better Data — Every interaction tracked and analyzed automatically
5. 💰 Lower Operating Costs — Do more with the same (or smaller) team
...
4. Test — Test with real scenarios, edge cases
5. Train + Monitor — Train your team, monitor for 30 days

**FAQ:**
Q: What can be automated?
A: Lead follow-ups, appointment reminders, customer onboarding, invoice generation, social media posting, data entry, report generation, and much more.

Q: Do I need technical knowledge to use the automation?
A: No. We build it so your team just uses it — no technical knowledge needed.

Q: What if the automation breaks?
A: We monitor during the first 30 days. After that, maintenance is available on retainer.
...
4. 🧪 Continuous Testing — Automatically tests ad variations to find winners
5. 💸 Reduced Wasted Spend — AI cuts off underperforming ads before they drain budget
...
4. Launch — Go live with initial campaigns
5. Optimize — Continuous AI optimization + monthly human review
...
4. 📈 Improves Over Time — Learns from usage, gets smarter with use
5. 🏷️ Branded Experience — Customers interact with YOUR AI, not a third-party tool
6. ⚙️ Fully Customizable — Change behavior, tone, capabilities anytime

**Tech Stack:**
Python, LangChain, OpenAI API, Pinecone, PostgreSQL, Next.js

**FAQ:**
Q: Can you build a chatbot for my website?
A: Yes — trained on your FAQs, products, services. Answers customer questions 24/7.

Q: Is my data safe?
A: Yes — we build private AI systems. Your data is never used to train public models.
...
4. ⚡ Immediate Results — Unlike SEO, ads can drive traffic from day 1
5. 🔄 Continuous Optimization — Regular bid + keyword + ad copy optimization
...
4. Launch — Go live + initial monitoring
5. Optimize — Weekly optimizations + monthly reporting

**FAQ:**
Q: What's the minimum budget?
A: We recommend minimum ₹15,000–20,000/month ad spend (separate from our management fee).

Q: How long until I see results?
A: Usually 2–4 weeks to gather data, 4–8 weeks to see meaningful optimization.
...
4. 📊 Pixel Tracking — Track every action from ad click to purchase
5. 🔄 Retargeting — Re-engage people who visited your website but didn't convert
...
4. 📈 Authority Building — Google rankings build trust with potential customers
5. 📊 Full Transparency — Monthly ranking reports + traffic analytics
...
**Timeline:** 3–6 months to see significant results (SEO is a long game)

**FAQ:**
Q: How long until I rank on page 1?
A: Usually 3–6 months for competitive keywords, sometimes faster for local/niche terms. SEO is a long-term investment.

Q: Do I need to keep paying monthly?
A: SEO is ongoing — algorithms change, competitors optimize. We recommend at least 6 months to see real results.
...
4. 📊 Growth Tracking — Monthly follower + engagement analytics
5. 🎯 Platform-Specific Strategy — Different content approach per platform
...
**Platforms:** Instagram, Facebook, LinkedIn (add Twitter/X extra)
...
4. 📊 Measurable — Open rates, click rates, conversions — everything tracked
5. 🔒 You Own Your List — Unlike social media, your email list is yours forever
...
4. 🔄 Iterative Process — Multiple rounds of feedback, nothing final until you're happy
5. 📁 Developer-Ready Files — Clean Figma files with design system, ready to hand off
...
4. Visual Design — High-fidelity UI, brand application
5. Prototype + Handoff — Interactive prototype + developer-ready Figma
...
4. Delivery — Final files (AI, PNG, PDF, SVG)
...
**FAQ:**
Q: What format should I send the raw footage in?
A: Any format works — MP4, MOV, AVI. Higher quality = better output.

Q: Do you shoot video too?
A: Currently editing only. For shooting, we can recommend local videographers.
