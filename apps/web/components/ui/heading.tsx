...
export function Heading({
  ...
  const styles = {
    h1: 'font-poppins font-extrabold text-3xl sm:text-4xl md:text-5xl lg:text-6xl tracking-tight text-foreground transition-colors duration-300',
    h2: 'font-poppins font-bold text-2xl sm:text-3xl md:text-4xl tracking-tight text-foreground transition-colors duration-300',
