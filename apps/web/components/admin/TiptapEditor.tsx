      ...
      {isMediaOpen && (
        ...
        >
          ...
          >
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  {getBlogImages().map((src, index) => (
                    <div
                      ...
                      className="aspect-square w-full rounded-lg overflow-hidden border border-slate-200 dark:border-slate-850 cursor-pointer relative group hover:scale-[1.02] hover:border-brand-orange transition-all duration-200"
                    >
            ...
            <div className="px-6 py-3 border-t border-slate-200 dark:border-slate-800 text-right text-[10px] text-slate-500 font-medium">
