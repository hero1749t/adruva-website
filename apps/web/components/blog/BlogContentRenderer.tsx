  ...
  switch (node.type) {
    ...
    case "paragraph":
      return (
        <p
          key={index}
          className="text-lg leading-relaxed text-slate-600 dark:text-slate-300 font-manrope mb-4"
        >
          {children}
        </p>
      );
    case "heading": {
      ...
      if (level === 2) {
        return (
          <h2
            key={index}
            className="text-2xl md:text-3xl font-bold font-sora text-slate-900 dark:text-white mt-10 mb-4 first:mt-0"
          >
            {children}
          </h2>
        );
      ...
      if (level === 3) {
        return (
          <h3
            key={index}
            className="text-xl md:text-2xl font-semibold font-sora text-slate-900 dark:text-white mt-8 mb-3"
          >
            {children}
          </h3>
        );
      ...
      return (
        <h4
          key={index}
          className="text-lg md:text-xl font-semibold font-sora text-slate-900 dark:text-white mt-6 mb-2"
        >
          {children}
        </h4>
      );
    ...
    case "bulletList":
      return (
        <ul
          key={index}
          className="list-disc pl-6 space-y-2 mb-6 text-slate-600 dark:text-slate-300 font-manrope text-lg"
        >
          {children}
        </ul>
      );
    case "orderedList":
      return (
        <ol
          key={index}
          className="list-decimal pl-6 space-y-2 mb-6 text-slate-600 dark:text-slate-300 font-manrope text-lg"
        >
          {children}
        </ol>
      );
    ...
    case "blockquote":
      return (
        <blockquote
          key={index}
          className="border-l-4 border-primary bg-secondary/5 dark:bg-secondary/15 px-6 py-4 my-6 italic text-slate-600 dark:text-slate-300 rounded-r font-manrope text-lg whitespace-pre-line"
        >
          {children}
        </blockquote>
      );
