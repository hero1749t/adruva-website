...
export function TestimonialsSection() {
  ...
  return (
    <section className="w-full py-16 md:py-24 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
      <div className="max-w-[1400px] mx-auto bg-[#0A0A0A] text-white rounded-[32px] py-20 relative overflow-hidden border border-white/5 shadow-2xl">
        {/* Background glow */}
