        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-16 relative z-10">
          <div className="flex flex-col items-start">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-foreground font-poppins">
              Full-spectrum <span className="bg-gradient-to-r from-brand-blue to-brand-orange bg-clip-text text-transparent">digital services</span>
            </h2>
          </div>
            ...
            return (
              <motion.div
                ...
                className={cn(
                  ...
                  service.theme === 'blue' && 'hover:border-blue-500/30 hover:shadow-[0_20px_40px_rgba(45,140,255,0.06),0_4_12px_rgba(45,140,255,0.03)]',
                  service.theme === 'orange' && 'hover:border-brand-orange/30 hover:shadow-[0_20px_40px_rgba(255,107,0,0.06),0_4_12px_rgba(255,107,0,0.03)]',
                  service.theme === 'purple' && 'hover:border-purple-500/30 hover:shadow-[0_20px_40px_rgba(168,85,247,0.06),0_4_12px_rgba(168,85,247,0.03)]'
                )}
              >
                {/* Hover Top Color Bar */}
                <div className={cn(
                ...
                <div className={cn(
                  ...
                  service.theme === 'blue' && "bg-[radial-gradient(circle_at_center,rgba(45,140,255,0.18)_0%,transparent_60%)]",
                  service.theme === 'orange' && "bg-[radial-gradient(circle_at_center,rgba(255,107,0,0.18)_0%,transparent_60%)]",
                  service.theme === 'purple' && "bg-[radial-gradient(circle_at_center,rgba(168,85,247,0.18)_0%,transparent_60%)]"
                )} />
                ...
                <div className={cn(
                  ...
                  service.theme === 'blue' && "bg-blue-500/8 text-blue-500 dark:bg-blue-500/12 border border-blue-500/20 group-hover:bg-blue-500/18 shadow-[0_4px_12px_rgba(45,140,255,0.1)]",
                  service.theme === 'orange' && "bg-brand-orange/8 text-brand-orange dark:bg-brand-orange/12 border border-brand-orange/20 group-hover:bg-brand-orange/18 shadow-[0_4px_12px_rgba(255,107,0,0.1)]",
                  service.theme === 'purple' && "bg-purple-500/8 text-purple-500 dark:bg-purple-500/12 border border-purple-500/20 group-hover:bg-purple-500/18 shadow-[0_4px_12px_rgba(168,85,247,0.1)]"
                )}>
                ...
                <h3 className={cn(
                  ...
                  service.theme === 'blue' && "group-hover:text-blue-500 dark:group-hover:text-blue-400",
                  service.theme === 'orange' && "group-hover:text-brand-orange",
                  service.theme === 'purple' && "group-hover:text-purple-500 dark:group-hover:text-purple-400"
                )}>
                  {service.name}
                </h3>
                ...
                <div className="flex flex-col gap-3.5 w-full mt-auto pt-4 border-t border-border/40">
                  <div className={cn(
                    ...
                    service.theme === 'blue' && "bg-blue-500/[0.06] border-blue-500/20 text-blue-500 dark:text-blue-400",
                    service.theme === 'orange' && "bg-brand-orange/[0.06] border-brand-orange/20 text-brand-orange",
                    service.theme === 'purple' && "bg-purple-500/[0.06] border-purple-500/20 text-purple-500 dark:text-purple-400"
                  )}>
                    {service.price}
                  </div>
                  ...
                  <Link 
                    ...
                    className={cn(
                      ...
                      service.theme === 'blue' && "text-blue-500 hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-300",
                      service.theme === 'orange' && "text-brand-orange hover:text-brand-orange-hover",
                      service.theme === 'purple' && "text-purple-500 hover:text-purple-600 dark:text-purple-400 dark:hover:text-purple-300"
                    )}
                  >
                    Learn More
