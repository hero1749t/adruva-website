...
export function Footer() {
  ...
  return (
    <footer className="w-full bg-[#0A0A0A] text-white border-t border-white/10 pt-16 pb-8 transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="pt-2">
              ...
              <form onSubmit={handleSubscribe} className="flex gap-2 max-w-[260px] w-full">
                <Input
                  type="email"
                  value={email}
          ...
          <div>
            ...
            <div className="flex flex-col space-y-3.5 text-sm text-gray-400 mb-6 font-inter">
              <div className="flex items-start gap-3">
                ...
                <a href="mailto:hello@adruvasolution.com" className="hover:text-white transition-colors">
