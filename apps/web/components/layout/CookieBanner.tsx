            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1 leading-relaxed">
                    We use cookies to optimize site features, analyze traffic,
                    and personalize marketing content. Check &quot;Manage&quot;
              ...
              <div className="flex flex-col sm:flex-row gap-2 pt-2">
                <Button
                  ...
                  className="bg-brand-blue hover:bg-brand-blue/90 text-white text-xs py-2 h-auto flex-1 font-semibold"
                >
                  Accept All
                </Button>
                <Button
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start justify-between p-2 rounded-lg bg-muted/40">
                  <div>
                    ...
                    <p className="text-[10px] text-muted-foreground mt-0.5">
                      Required for core site operation & theme toggling.
                    </p>
                  </div>
                  <span className="text-[10px] bg-brand-blue/10 text-brand-blue px-2 py-0.5 rounded font-medium">
                    Always Active
                  </span>
                </div>
                ...
                >
                  <div className="pr-4">
                    ...
                    <p className="text-[10px] text-muted-foreground mt-0.5">
                      Helps us understand how users navigate and find content
                      (Google Analytics).
                    </p>
                  </div>
                  <div
                ...
                >
                  <div className="pr-4">
                    ...
                    <p className="text-[10px] text-muted-foreground mt-0.5">
                      Enables tracking and scripts for Calendly, Sentry, and
              ...
              <div className="flex gap-2 pt-2">
                <Button
                  ...
                  className="bg-brand-blue hover:bg-brand-blue/90 text-white text-xs py-2 h-auto w-full font-semibold"
                >
                  Save Selection
                </Button>
              </div>
