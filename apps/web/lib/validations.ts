...
export const contactFormSchema = z.object({
  ...
  serviceInterested: z
    .string()
    .min(1, { message: "Please select a service of interest." }),
  budgetRange: z
    .string()
    .min(1, { message: "Please select your budget range." }),
  timeline: z
    .string()
    .min(1, { message: "Please select your project timeline." }),
  message: z
    .string()
...
export const jobApplicationSchema = z.object({
  ...
  qualification: z
    .string()
    .min(1, { message: "Please select your highest qualification." }),
  experienceLevel: z
    .string()
