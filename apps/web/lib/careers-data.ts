...
export const DEFAULT_PROCESS_STEPS: ProcessStep[] = [
  {
    ...
    title: "Apply Online",
    description:
      "Submit your resume and cover letter answering our core questions.",
  },
  {
    step: 2,
    title: "Resume Review",
    description:
      "Our hiring manager reviews your portfolio and experience within 7 business days.",
  },
  {
    step: 3,
    title: "Practical Screening",
    description:
      "A short, role-specific task to assess your real-world problem-solving skills.",
  },
  {
    step: 4,
    title: "Technical Interview",
    description:
      "A 45-minute video call discussing your task solution and technical choices.",
  },
  {
    step: 5,
    title: "Hiring Offer",
    description:
      "Welcome to the team! We roll out formal offers with complete milestone benefits.",
  },
];
...
export const mockJobs: JobListing[] = [
  {
    ...
    description:
      "We are looking for a Full Stack Developer to join our growing engineering team in Dehradun. You will own client projects end-to-end, writing clean code in Next.js and NestJS, optimizing PostgreSQL databases, and collaborating directly with product managers.",
    responsibilities: [
  ...
  },
  {
    ...
    description:
      "We are seeking an experienced AI Automation Engineer to design, build, and deploy intelligent system workflows for our enterprise clients. You will integrate Large Language Models (LLMs), build autonomous agents, connect custom CRM webhooks, and automate complex business operations.",
    responsibilities: [
    ...
    process_steps: [
      {
        ...
        description:
          "Submit your profile, GitHub repositories, and brief descriptions of AI tools you have built.",
      },
      {
        step: 2,
        title: "Technical Review",
        description:
          "Our lead architect evaluates your projects and code structure.",
      },
      {
        step: 3,
        title: "AI Engineering Task",
        description:
          "Build a mini-agent that qualifies inbound requests (completed in 48 hours).",
      },
      {
        step: 4,
        title: "Architecture Interview",
        description:
          "A deep-dive video session walking through your task and explaining system scale solutions.",
      },
      {
        step: 5,
        title: "Offer & Onboarding",
        description: "Formal salary and benefit proposal rolled out.",
      },
    ],
    perks: [
  ...
  },
  {
    ...
    description:
      "Adruva Solution is looking for a passionate UI/UX Design Intern. You will work directly with our design lead and engineering team to construct wireframes, design intuitive client dashboard layouts, map user flows, and compile complete Figma design systems for real-world products.",
    responsibilities: [
    ...
    process_steps: [
      {
        ...
        description:
          "Share your Behance, Dribbble, or custom Figma links showcasing web/mobile layouts.",
      },
      {
        step: 2,
        title: "Practical Challenge",
        description:
          "Design a 3-page web flow based on a brief (expected time: 4-6 hours).",
      },
      {
        step: 3,
        title: "Design Interview",
        description:
          "Walk through your designs and discuss style components and user decisions.",
      },
      {
        step: 4,
        title: "Offer Letter",
        description:
          "Onboard as a paid intern with formal LOR and potential PPO options.",
      },
    ],
    perks: [
  ...
  },
  {
    ...
    experience_level: "fresher",
    description:
      "We are seeking a high-energy SEO and Content Writing Intern based in Dehradun. You will learn the mechanics of search engine rankings, write search-intent blog content, analyze keywords, perform on-page SEO audits, and help grow organic traffic for Adruva and its clients.",
    responsibilities: [
    ...
    process_steps: [
      {
        step: 1,
        title: "Writing Samples Review",
        description:
          "Submit 2-3 links or files of your written articles, academic drafts, or reviews.",
      },
      {
        step: 2,
        title: "Content Task",
        description:
          "Write a 600-word informative guide based on an assigned keyword brief.",
      },
      {
        step: 3,
        title: "Review Interview",
        description:
          "A short chat at our office discussing content angles, structure, and career plans.",
      },
      {
        step: 4,
        title: "Stipend Onboarding",
        description: "Offer letter signoff for the 3-month internship.",
      },
    ],
    perks: [
      "Paid monthly stipend.",
...
export function mapDbJobToJobListing(dbJob: any): JobListing {
  return {
    id: dbJob.id,
    title: dbJob.title,
    slug: dbJob.slug,
    ...
    location_type: dbJob.locationType || "remote",
    experience_level: dbJob.experienceLevel || "fresher",
    description: dbJob.description || "",
    responsibilities: dbJob.responsibilities || [],
    requirements: dbJob.requirements || [],
    skills_required: dbJob.skillsRequired || [],
    salary_min: dbJob.salaryMin,
    salary_max: dbJob.salaryMax,
    salary_label: dbJob.salaryLabel || "",
    is_paid: dbJob.isPaid !== undefined ? dbJob.isPaid : true,
    duration: dbJob.duration || undefined,
    openings_count: dbJob.openingsCount || 1,
    application_deadline: dbJob.applicationDeadline
      ? new Date(dbJob.applicationDeadline).toISOString().split("T")[0] || ""
      : "",
    process_steps: dbJob.processSteps
      ? typeof dbJob.processSteps === "string"
        ? JSON.parse(dbJob.processSteps)
        : dbJob.processSteps
