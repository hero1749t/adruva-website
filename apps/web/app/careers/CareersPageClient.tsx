...
export function CareersPageClient({
  ...
  const activeJobs = (
    initialJobs && initialJobs.length > 0 ? initialJobs : mockJobs
  ...
  const uniqueDepartments = Array.from(
    new Set(activeJobs.map((job) => job.department)),
  );
  ...
  return (
    <div className="w-full bg-background text-foreground transition-colors duration-300">
            ...
            {cultureCards.map((card, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={cn(
                      "inline-flex p-3 rounded-xl mb-5 text-sm font-semibold",
                      card.color,
                    )}
                  >
      ...
      <Section
        id="open-positions"
        className="py-16 md:py-24 bg-muted/5 scroll-mt-20"
      >
        <Container>
          <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          {filteredJobs.length > 0 ? (
                  ...
                  <div>
                    ...
                    <div className="flex items-start justify-between gap-4 mb-4">
                      ...
                      <div className="flex flex-wrap gap-1.5 justify-end">
                        ...
                        <Badge
                          variant="secondary"
                          className="bg-muted text-muted-foreground text-[9px] px-2 py-0.5 rounded-full capitalize font-semibold border-none"
                        >
                          {job.location_type}
                        </Badge>
                      </div>
            ...
            <div className="text-center py-16 px-6 border border-dashed border-border/50 rounded-2xl bg-card/40 max-w-md mx-auto">
              ...
              <Button
                ...
                variant="outline"
                className="text-xs h-9 font-semibold rounded-lg px-4"
              >
                Reset Filters
              </Button>
            </div>
