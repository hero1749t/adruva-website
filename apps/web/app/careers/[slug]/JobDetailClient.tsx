...
export function JobDetailClient({ job }: Props) {
  ...
  const [submittedData, setSubmittedData] =
    useState<JobApplicationValues | null>(null);
  ...
  const onSubmit = async (values: JobApplicationValues) => {
    ...
    try {
      ...
      toast.error(
        "Something went wrong. Please submit your application via WhatsApp.",
      );
    }
  };
            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 p-4 rounded-xl border border-border/40 bg-card/40 font-space-grotesk">
                <div className="flex flex-col">
                  ...
                  <span className="text-xs font-extrabold text-brand-navy dark:text-white mt-1 capitalize">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2 pt-1">
                    {job.skills_required.map((skill, i) => (
                      <span
                        key={i}
                        className="text-xs font-medium bg-muted text-muted-foreground border border-border/40 px-3 py-1 rounded-lg"
                      >
                        {skill}
                      </span>
                    ))}
                    ...
                    <div className="mb-6 p-4 rounded-xl bg-green-500/10 border border-green-500/20 text-green-700 dark:text-green-400 flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] mt-1">
                          We have received your application successfully. Our
                          team will review your details and resume within 7
                          business days.
                        </p>
                      </div>
                    </div>
                  ...
                  {submitStatus === "error" && (
                    <div className="mb-6 p-4 rounded-xl bg-red-500/10 border border-red-500/20 text-red-700 dark:text-red-400 flex items-start gap-3">
                      ...
                      <div className="flex-grow">
                        ...
                        <p className="text-[11px] mt-1">
                          Server connection failed. Please click the button
                          below to submit your details directly via WhatsApp
                          instead.
                        </p>
                        <a
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                    ...
                    <div className="space-y-1.5">
                      ...
                      {errors.currentLocation && (
                        <p className="text-[10px] text-red-500 mt-1">
                          {errors.currentLocation.message as string}
                        </p>
                      )}
                    </div>
