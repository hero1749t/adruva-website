...
export const metadata: Metadata = {
  title: "Cookie Policy",
  description:
    "Understand how Adruva Solution uses cookies to enhance theme selections, measure analytical data, and protect public forms.",
  alternates: {
          ...
          <div className="max-w-[800px] mx-auto space-y-10">
            ...
            <div className="prose prose-lg dark:prose-invert font-inter text-text-secondary dark:text-gray-300 space-y-6 leading-relaxed">
              <p>
                ...
                ). We believe in complete transparency about how we collect and
                manage your data.
              </p>
              ...
              <p>
                ...
                device by websites you visit. They are widely used to make
                websites work more efficiently, improve browsing experience, and
              ...
              <p>
                We use cookies to enhance your experience, ensure form security,
                and study site traffic patterns. Specifically, we use cookies
                for:
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong>Preferences:</strong> Next-themes cookies to store
                  your choice of light or dark theme mode.
                </li>
                <li>
                  <strong>Security:</strong> Google reCAPTCHA v3 cookies to
                  protect our forms (Contact, Newsletter, Careers) from bot spam
                  and abuse.
                </li>
                <li>
                  <strong>Analytics:</strong> Google Analytics cookies to track
                  anonymous traffic statistics, such as pages visited, bounce
              ...
              <p>
                The cookies used on our website fall into the following
                categories:
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong>Strictly Necessary:</strong> Essential for standard
                  page routing and basic operations (e.g. security and theme
                  choice). These cookies do not store any personally
                  identifiable info and cannot be turned off.
                </li>
                <li>
                  <strong>Performance & Analytics:</strong> Help us measure
                  visitor volumes and navigation patterns so we can improve site
                  speed and structure. All collected data is aggregated and
                  anonymized.
                </li>
              </ul>
              ...
              <p>
                ...
                You can also clear cookies stored in your browser history at any
                time.
              </p>
              <p>
                Please note that if you choose to reject or disable cookies,
                certain parts of our website (such as theme preferences or
                secure form submissions protected by reCAPTCHA) may not function
                correctly.
              </p>
              ...
              <p>
                If you have any questions or require details regarding our
                cookie usage, please contact us at:
              </p>
