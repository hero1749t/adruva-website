...
export default function ServicesContentManager() {
  ...
  const startEditing = (service: Service) => {
    ...
    try {
      const f = service.faq
        ? typeof service.faq === "string"
          ? JSON.parse(service.faq)
          : service.faq
        : [];
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold font-sora text-slate-900 dark:text-white flex items-center gap-2">
              ...
              <span className="text-brand-blue">{selectedService.name}</span>
            </h2>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-[#151f32] rounded-xl">
              <CardHeader className="px-6 py-4 border-b border-slate-100 dark:border-slate-800/60">
                <CardTitle className="text-sm font-bold text-slate-900 dark:text-white uppercase font-sora">
                  Core Details
                </CardTitle>
              </CardHeader>
            ...
            <Card className="border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-[#151f32] rounded-xl">
              ...
              <CardContent className="p-6 space-y-6">
                ...
                <div className="space-y-1">
                  ...
                  <Textarea
                    rows={2}
                    placeholder="Brief details about the benefit..."
                ...
                <Button
                  ...
                  size="sm"
                  onClick={addBenefit}
                  className="flex items-center gap-1 border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-900"
                >
                ...
                <div className="space-y-2.5 pt-2">
                  {benefits.map((b, idx) => (
                    <div
                      key={idx}
                      className="flex justify-between items-start gap-4 p-3 rounded-lg border border-slate-100 dark:border-slate-800/40 bg-slate-50/50 dark:bg-slate-900/10"
                    >
                      <div className="min-w-0">
                        <div className="flex items-center gap-2">
                          <span className="text-[10px] font-bold uppercase tracking-wider text-brand-blue bg-brand-blue/5 px-2 py-0.5 rounded border border-brand-blue/10 font-mono">
                            {b.icon}
                          </span>
                          <h4 className="font-bold text-xs text-slate-800 dark:text-white leading-none truncate">
                            {b.title}
                          </h4>
                        </div>
                      ...
                      <Button
                        ...
                        className="h-6 w-6 p-0 text-slate-400 hover:text-red-500 hover:bg-red-500/5"
                      >
            ...
            <Card className="border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-[#151f32] rounded-xl">
              ...
              <CardContent className="p-6 space-y-4">
                <div className="space-y-1">
                  ...
                  <Input
                    placeholder="e.g. Do I get source code ownership?"
                    value={newQ}
          ...
          <div className="space-y-6">
              ...
              <CardContent className="p-6 space-y-4">
                <div className="flex gap-2">
                  <Input
                    ...
                    className="bg-slate-50 dark:bg-slate-950 border-slate-200 dark:border-slate-850 h-9"
                  />
                  <Button
                    size="sm"
                    onClick={addTech}
            ...
            <Card className="border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-[#151f32] rounded-xl">
              ...
              <CardContent className="p-6 space-y-4">
                <div className="flex gap-2">
                  <Input
                    placeholder="e.g. Free hosting support"
                    value={newIncluded}
                ...
                <div className="space-y-1.5 pt-2">
                  {whatsIncluded.map((item) => (
                    <div
                      key={item}
                      className="flex justify-between items-center p-2 border border-slate-100 dark:border-slate-800/40 rounded bg-slate-50/50 dark:bg-slate-900/5 text-xs text-slate-600 dark:text-slate-400"
                    >
                      ...
                      <Button
                        ...
                        className="h-5 w-5 p-0 text-slate-400 hover:text-red-500 hover:bg-red-500/5"
                      >
            ...
            <Card className="border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-[#151f32] rounded-xl">
              <CardContent className="p-6 space-y-3">
                <Button
                  ...
                  className="w-full bg-brand-blue hover:bg-brand-blue-dark text-white flex items-center justify-center gap-2"
                >
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-xs text-slate-500 dark:text-slate-400 font-manrope">
          Manage descriptions, Pricing levels, and FAQ segments of Adruva
          offerings
        </p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center text-slate-500 text-sm py-12">
          No services found in database. Check migrations & seed data.
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {data.data.map((service) => (
            <Card
              key={service.id}
              className="border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-[#151f32] shadow-sm hover:shadow-md transition-all duration-200 rounded-xl flex flex-col justify-between"
            >
              <CardHeader className="p-6 pb-4">
                <div className="flex justify-between items-start mb-2">
                  <span className="text-[10px] font-bold bg-slate-100 dark:bg-slate-800 px-2 py-0.5 rounded capitalize text-slate-500 dark:text-slate-400 border border-slate-200/20">
                    {service.category}
                  </span>
                  {!service.isActive && (
                    <Badge
                ...
                <CardTitle className="text-base font-bold font-sora text-slate-900 dark:text-white leading-snug">
                  {service.name}
                </CardTitle>
                <CardDescription className="text-slate-400 dark:text-slate-500 text-xs font-mono mt-1 font-semibold">
                  {service.startingPrice || "Custom Quote"}
                </CardDescription>
              </CardHeader>
              <CardContent className="p-6 pt-0 flex flex-col justify-end">
                <p className="text-xs text-slate-500 dark:text-slate-400 line-clamp-3 mb-4 font-manrope leading-relaxed">
                ...
                <Button
                  ...
                  className="w-full flex items-center justify-center gap-1.5 border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-900"
                >
