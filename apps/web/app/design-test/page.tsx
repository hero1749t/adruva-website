  ...
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300">
      ...
      <div className="sticky top-0 z-50 w-full border-b bg-background/80 backdrop-blur-md transition-colors duration-300">
        <Container className="flex h-16 items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="font-sora font-extrabold text-lg tracking-tight text-primary">
        ...
        <Container>
          <div className="max-w-2xl">
            ...
            <Text variant="marketing" size="lg" className="mb-6">
              This page showcases and tests the custom typography components,
              layout wrappers, and Shadcn UI components configured to match the
              Adruva Solution style guides.
            </Text>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Text variant="marketing" size="lg">
                    This is marketing body text in Space Grotesk font. It feels
                    modern and has geometric proportions.
                  </Text>
                </div>
                <div>
                  <Label>
                  ...
                  <Text variant="body" size="base">
                    This is base body text in Inter font. It has a line height
                    of 1.7 for clean, comfortable reading on screens of all
                    sizes.
                  </Text>
                </div>
                <div>
                  ...
                  <Text variant="muted" size="sm">
                    This is muted small body text, ideal for descriptions,
                    labels, and supplementary information.
                  </Text>
                </div>
              </div>
            </div>
      ...
      <Section dark className="my-8">
        <Container>
          <Label className="text-primary font-bold mb-2 block">
            2. Dark Section Wrapper (Forces Black Background)
          </Label>
          ...
          <Text className="text-gray-300 mb-6 max-w-2xl">
            This is used for high-impact callouts or dark segments on the
            homepage (like the Growth System or Hero). It ignores the system
            light/dark mode for background coloring, remaining dark in both
            modes while rendering light readable text.
          </Text>
          <Button
            variant="default"
        ...
        <Container>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Card className="hover:border-primary/30 transition-all duration-300 hover:-translate-y-1">
              <CardHeader>
                <CardTitle className="font-sora">Button Styles</CardTitle>
              ...
              <CardFooter>
                <Text size="sm" variant="muted">
                  Hover translation works on cards
                </Text>
              </CardFooter>
            </Card>
            ...
            <Card className="hover:border-primary/30 transition-all duration-300 hover:-translate-y-1">
              <CardHeader>
                <CardTitle className="font-sora">Badge Badges</CardTitle>
                <CardDescription>
                  Colored tags for services and status
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex flex-wrap gap-2">
                  ...
                  <Badge
                    variant="secondary"
                    className="bg-[#2D8CFF]/10 text-[#2D8CFF] hover:bg-[#2D8CFF]/20"
                  >
                    Blue Tag
                  </Badge>
                  <Badge
              ...
              <CardFooter>
                <Text size="sm" variant="muted">
                  Using custom variants or overrides
                </Text>
              </CardFooter>
            </Card>
            ...
            <Card className="hover:border-primary/30 transition-all duration-300 hover:-translate-y-1 col-span-1 md:col-span-2 lg:col-span-1">
              <CardHeader>
                <CardTitle className="font-sora">Form Fields</CardTitle>
                <CardDescription>
                  Text inputs and validation focus states
                </CardDescription>
              </CardHeader>
        ...
        <Container>
            ...
            <div className="space-y-4">
              ...
              <Tabs defaultValue="build" className="w-full">
                ...
                <TabsContent value="build">
                  <Card>
                    <CardHeader>
                      <CardTitle className="font-sora text-base">
                        Website & Software Development
                      </CardTitle>
                      <CardDescription>
                        Custom web applications, SaaS tools, and e-commerce.
                      </CardDescription>
                    </CardHeader>
                  </Card>
                </TabsContent>
                <TabsContent value="automate">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Lead CRM sync, Meta APIs, WhatsApp webhooks.
                      </CardDescription>
                    </CardHeader>
                  </Card>
                </TabsContent>
                <TabsContent value="grow">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Google Ads, Meta campaigns, SEO rankings.
                      </CardDescription>
                    </CardHeader>
                  </Card>
                </TabsContent>
          ...
          <div className="flex flex-wrap items-center justify-between gap-8">
            <div className="flex-1 min-w-[280px]">
              ...
              {loading ? (
                ...
                <div className="p-4 border rounded-card bg-card text-card-foreground">
                  <Text size="sm">
                    Skeleton loader testing area. Click &quot;Test Skeleton
                    Loader&quot; above to trigger.
                  </Text>
                </div>
              )}
            </div>
            ...
            <div className="flex items-center justify-start">
              <Dialog>
                <DialogTrigger
                  render={<Button variant="outline">Open Modal Dialog</Button>}
                />
                ...
                <DialogContent className="sm:max-w-[425px]">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      This dialog is styled with our theme variables and
                      supports transitions.
                    </DialogDescription>
                  </DialogHeader>
                  <div className="grid gap-4 py-4">
                    <Text size="sm">
                      Our dialog component uses standard HTML overlays powered
                      by Radix primitives and styled with Tailwind variables.
                    </Text>
                  </div>
                  <DialogFooter>
