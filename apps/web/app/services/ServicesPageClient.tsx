                ...
                return (
                  <motion.div
                    ...
                    className={cn(
                      ...
                      theme === 'blue' && 'hover:border-blue-500/30 hover:shadow-[0_20px_40px_rgba(45,140,255,0.06),0_4_12px_rgba(45,140,255,0.03)]',
                      theme === 'orange' && 'hover:border-brand-orange/30 hover:shadow-[0_20px_40px_rgba(255,107,0,0.06),0_4_12px_rgba(255,107,0,0.03)]',
                      theme === 'purple' && 'hover:border-purple-500/30 hover:shadow-[0_20px_40px_rgba(168,85,247,0.06),0_4_12px_rgba(168,85,247,0.03)]',
                      theme === 'pink' && 'hover:border-pink-500/30 hover:shadow-[0_20px_40px_rgba(236,72,153,0.06),0_4_12px_rgba(236,72,153,0.03)]'
                    )}
                  >
                    {/* Hover Top Color Bar */}
                    <div className={cn(
                    ...
                    <div className={cn(
                      ...
                      theme === 'blue' && "bg-[radial-gradient(circle_at_center,rgba(45,140,255,0.18)_0%,transparent_60%)]",
                      theme === 'orange' && "bg-[radial-gradient(circle_at_center,rgba(255,107,0,0.18)_0%,transparent_60%)]",
                      theme === 'purple' && "bg-[radial-gradient(circle_at_center,rgba(168,85,247,0.18)_0%,transparent_60%)]",
                      theme === 'pink' && "bg-[radial-gradient(circle_at_center,rgba(236,72,153,0.18)_0%,transparent_60%)]"
                    )} />
                    ...
                    <div>
                      ...
                      <div className="flex items-center justify-between mb-5">
                        ...
                        <div className={cn(
                          ...
                          theme === 'blue' && "bg-blue-500/8 text-blue-500 dark:bg-blue-500/12 border border-blue-500/20 group-hover:bg-blue-500/18 shadow-[0_4px_12px_rgba(45,140,255,0.1)]",
                          theme === 'orange' && "bg-brand-orange/8 text-brand-orange dark:bg-brand-orange/12 border border-brand-orange/20 group-hover:bg-brand-orange/18 shadow-[0_4px_12px_rgba(255,107,0,0.1)]",
                          theme === 'purple' && "bg-purple-500/8 text-purple-500 dark:bg-purple-500/12 border border-purple-500/20 group-hover:bg-purple-500/18 shadow-[0_4px_12px_rgba(168,85,247,0.1)]",
                          theme === 'pink' && "bg-pink-500/8 text-pink-500 dark:bg-pink-500/12 border border-pink-500/20 group-hover:bg-pink-500/18 shadow-[0_4px_12px_rgba(236,72,153,0.1)]"
                        )}>
                          <Icon className="h-5 w-5" />
                        </div>
                        <span className={cn(
                          "text-[10px] font-bold uppercase tracking-widest px-2.5 py-1 rounded-full font-space-grotesk",
                          theme === 'blue' && "bg-blue-500/10 text-blue-500 dark:bg-blue-500/15 dark:text-blue-400",
                          theme === 'orange' && "bg-brand-orange/10 text-brand-orange dark:bg-brand-orange/15 dark:text-brand-orange-hover",
                          theme === 'purple' && "bg-purple-500/10 text-purple-500 dark:bg-purple-500/15 dark:text-purple-400",
                          theme === 'pink' && "bg-pink-500/10 text-pink-500 dark:bg-pink-500/15 dark:text-pink-400"
                        )}>
                          {service.category}
                        </span>
                      </div>
                      ...
                      <h3 className={cn(
                        ...
                        theme === 'blue' && "group-hover:text-blue-500 dark:group-hover:text-blue-400",
                        theme === 'orange' && "group-hover:text-brand-orange",
                        theme === 'purple' && "group-hover:text-purple-500 dark:group-hover:text-purple-400",
                        theme === 'pink' && "group-hover:text-pink-500 dark:group-hover:text-pink-400"
                      )}>
                        {service.name}
                      </h3>
                    ...
                    <div className="flex items-center justify-between border-t border-border/20 pt-4 mt-auto w-full">
                      <span className={cn(
                        ...
                        theme === 'blue' && "bg-blue-500/[0.06] border-blue-500/20 text-blue-500 dark:text-blue-400",
                        theme === 'orange' && "bg-brand-orange/[0.06] border-brand-orange/20 text-brand-orange",
                        theme === 'purple' && "bg-purple-500/[0.06] border-purple-500/20 text-purple-500 dark:text-purple-400",
                        theme === 'pink' && "bg-pink-500/[0.06] border-pink-500/20 text-pink-500 dark:text-pink-400"
                      )}>
                        {service.price}
                      </span>
                      ...
                      <Link 
                        ...
                        className={cn(
                          ...
                          theme === 'blue' && "text-blue-500 hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-300",
                          theme === 'orange' && "text-brand-orange hover:text-brand-orange-hover",
                          theme === 'purple' && "text-purple-500 hover:text-purple-600 dark:text-purple-400 dark:hover:text-purple-300",
                          theme === 'pink' && "text-pink-500 hover:text-pink-600 dark:text-pink-400 dark:hover:text-pink-300"
                        )}
                      >
                        Learn More
