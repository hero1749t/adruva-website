      ...
      <Section className="pb-8">
        <Container>
          <div className="text-center max-w-3xl mx-auto space-y-4">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold font-sora text-slate-900 dark:text-white tracking-tight">
              Insights & Resources
            </h1>
            <p className="text-lg md:text-xl text-slate-600 dark:text-slate-300 font-space leading-relaxed">
                ...
                <button
                  ...
                  className={`px-4 py-2 text-sm font-medium rounded-full transition-all duration-300 ${
                    selectedCategory === category
                      ...
                      : "bg-background hover:bg-muted text-slate-600 dark:text-slate-400 border border-border/50"
                  }`}
                >
                  {category}
                </button>
        ...
        <Container>
          <AnimatePresence mode="popLayout">
            {filteredPosts.length > 0 ? (
                  ...
                  >
                    <Card className="flex flex-col w-full group overflow-hidden border-border/80 bg-card hover:border-primary/40 dark:hover:border-primary/30 transition-all duration-300 hover:shadow-xl hover:shadow-primary/5 hover:-translate-y-1 rounded-xl">
                      ...
                      <CardHeader className="p-6 pb-2 space-y-3">
                        ...
                        >
                          <h3 className="text-xl font-bold font-sora text-slate-900 dark:text-white line-clamp-2 leading-tight">
                            {post.title}
                          </h3>
                        </Link>
                      </CardHeader>
                      ...
                      <CardContent className="p-6 pt-0 flex-grow">
                        <p className="text-sm text-slate-600 dark:text-slate-300 line-clamp-3 leading-relaxed font-manrope">
                          {post.summary}
                        </p>
                      </CardContent>
              ...
              >
                <Search className="w-12 h-12 text-slate-500 dark:text-slate-400 mx-auto mb-4" />
                <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">
                  No articles found
                </h3>
                <p className="text-slate-600 dark:text-slate-400 dark:text-gray-400">
